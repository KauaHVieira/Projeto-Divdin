Public Class selecao_quitar_despesas_grupo
    ...
    Private Sub selecao_quitar_despesas_grupo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        conecta_banco_mysql()
        carregar_quitar_despesas_grupo()
        carregar_tipos_dados_quitar_grupos()
    End Sub
    ...
    Private Sub txt_buscar_Click(sender As Object, e As EventArgs) Handles txt_buscar.Click
        With dgv_dados
            sql = $"SELECT 
               ...
               AND d.grupo_id = {id_gp} And {cmb_campo.Text} Like '{txt_buscar.Text}%'
